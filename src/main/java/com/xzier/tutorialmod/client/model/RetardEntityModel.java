package com.xzier.tutorialmod.client.model;
...
public class RetardEntityModel<T extends RetardEntity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(new ResourceLocation(TutorialMod.MODID, "retard_entity"), "main");

    private final ModelParts parts;

    public RetardEntityModel(ModelPart root) {
