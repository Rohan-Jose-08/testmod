...
import com.xzier.tutorialmod.Tile.ProcessorBlockEntity;
...
import static com.xzier.tutorialmod.Tile.ProcessorBlockEntity.SLOT_COUNT;
import static com.xzier.tutorialmod.Tile.ProcessorBlockEntity.SLOT_INPUT;
...
public class ProcessorContainer extends AbstractContainerMenu {
    ...
    public ProcessorContainer(int windowId, Player player, BlockPos pos) {
        super(MenuTypesInit.PROCESSOR_CONTAINER.get(), windowId);
        this.pos = pos;
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(player.level(), pos), player, BlockInit.PROCESSOR_BLOCK.get());
    }
