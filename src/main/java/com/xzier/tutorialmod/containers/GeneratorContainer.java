...
import static com.xzier.tutorialmod.Tile.GeneratorBlockEntity.SLOT;
import static com.xzier.tutorialmod.Tile.GeneratorBlockEntity.SLOT_COUNT;
...
public class GeneratorContainer extends AbstractContainerMenu {
    ...
    public GeneratorContainer(int windowId, Player player, BlockPos pos) {
        super(MenuTypesInit.GENERATOR_CONTAINER.get(), windowId);
        this.pos = pos;
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(player.level(), pos), player, BlockInit.GENERATOR_BLOCK.get());
    }
}
