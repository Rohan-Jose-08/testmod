...
public enum ModArmorMaterial implements ArmorMaterial {
    ...
    XZIER(TutorialMod.MODID + ":xzier", 20, new int[]{4, 7, 9, 4}, 50, SoundEvents.ARMOR_EQUIP_DIAMOND, 3.0F, 0.1F, () -> {
        return Ingredient.of(XZIER_GEM.get());
    }),
    FLAMING(TutorialMod.MODID + ":flaming", 20, new int[]{4, 7, 9, 4}, 50, SoundEvents.ARMOR_EQUIP_DIAMOND, 3.0F, 0.1F, () -> {
        return Ingredient.of(RARTED_ITEM.get());
    }),

    FREEZING(TutorialMod.MODID + ":freezing", 30, new int[]{4, 7, 9, 4}, 50, SoundEvents.ARMOR_EQUIP_TURTLE, 5.0F, 1.0F, () -> {
        return Ingredient.of(FROST_GEM.get());
    });
