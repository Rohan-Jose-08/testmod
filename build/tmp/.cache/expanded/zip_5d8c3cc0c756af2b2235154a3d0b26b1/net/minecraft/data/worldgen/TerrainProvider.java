...
public class TerrainProvider {
   ...
   public static final ToFloatFunction<Float> AMPLIFIED_OFFSET = ToFloatFunction.createUnlimited((p_236651_) -> {
      return p_236651_ < 0.0F ? p_236651_ : p_236651_ * 2.0F;
   });
   public static final ToFloatFunction<Float> AMPLIFIED_FACTOR = ToFloatFunction.createUnlimited((p_236649_) -> {
   ...
   public static <C, I extends ToFloatFunction<C>> CubicSpline<C, I> buildErosionJaggednessSpline(I pErosion, I pRidges, I pRidgesFolded, float p_236617_, float p_236618_, float p_236619_, float p_236620_, ToFloatFunction<Float> pTransform) {
      float f = -0.5775F;
   ...
   public static <C, I extends ToFloatFunction<C>> CubicSpline<C, I> getErosionFactor(I pErosion, I pRidges, I pRidgesFolded, float p_236626_, boolean p_236627_, ToFloatFunction<Float> pTransform) {
