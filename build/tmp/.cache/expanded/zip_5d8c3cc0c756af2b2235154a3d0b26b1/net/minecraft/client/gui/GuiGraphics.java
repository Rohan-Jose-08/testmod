...
public class GuiGraphics implements net.minecraftforge.client.extensions.IForgeGuiGraphics {
    ...
    * @param pWidth the width of the target portion.
    * @param pHeight the height of the target portion.
    * @param pCornerWidth the width of the corner slices.
    * @param pCornerHeight the height of the corner slices.
    * @param pEdgeWidth the width of the edge slices.
    * @param pEdgeHeight the height of the edge slices.
    * @param pUWidth the width of the source texture.
    * @param pVHeight the height of the source texture.
    ...
    */
   public void blitNineSliced(ResourceLocation pAtlasLocation, int pX, int pY, int pWidth, int pHeight, int pCornerWidth, int pCornerHeight, int pEdgeWidth, int pEdgeHeight, int pUWidth, int pVHeight, int pTextureX, int pTextureY) {
      pCornerWidth = Math.min(pCornerWidth, pWidth / 2);
      pEdgeWidth = Math.min(pEdgeWidth, pWidth / 2);
      pCornerHeight = Math.min(pCornerHeight, pHeight / 2);
      pEdgeHeight = Math.min(pEdgeHeight, pHeight / 2);
      if (pWidth == pUWidth && pHeight == pVHeight) {
         ...
         this.blit(pAtlasLocation, pX, pY, pTextureX, pTextureY, pCornerWidth, pHeight);
         this.blitRepeating(pAtlasLocation, pX + pCornerWidth, pY, pWidth - pEdgeWidth - pCornerWidth, pHeight, pTextureX + pCornerWidth, pTextureY, pUWidth - pEdgeWidth - pCornerWidth, pVHeight);
         this.blit(pAtlasLocation, pX + pWidth - pEdgeWidth, pY, pTextureX + pUWidth - pEdgeWidth, pTextureY, pEdgeWidth, pHeight);
      } else if (pWidth == pUWidth) {
         this.blit(pAtlasLocation, pX, pY, pTextureX, pTextureY, pWidth, pCornerHeight);
         this.blitRepeating(pAtlasLocation, pX, pY + pCornerHeight, pWidth, pHeight - pEdgeHeight - pCornerHeight, pTextureX, pTextureY + pCornerHeight, pUWidth, pVHeight - pEdgeHeight - pCornerHeight);
         this.blit(pAtlasLocation, pX, pY + pHeight - pEdgeHeight, pTextureX, pTextureY + pVHeight - pEdgeHeight, pWidth, pEdgeHeight);
      } else {
         this.blit(pAtlasLocation, pX, pY, pTextureX, pTextureY, pCornerWidth, pCornerHeight);
         this.blitRepeating(pAtlasLocation, pX + pCornerWidth, pY, pWidth - pEdgeWidth - pCornerWidth, pCornerHeight, pTextureX + pCornerWidth, pTextureY, pUWidth - pEdgeWidth - pCornerWidth, pCornerHeight);
         this.blit(pAtlasLocation, pX + pWidth - pEdgeWidth, pY, pTextureX + pUWidth - pEdgeWidth, pTextureY, pEdgeWidth, pCornerHeight);
         this.blit(pAtlasLocation, pX, pY + pHeight - pEdgeHeight, pTextureX, pTextureY + pVHeight - pEdgeHeight, pCornerWidth, pEdgeHeight);
         this.blitRepeating(pAtlasLocation, pX + pCornerWidth, pY + pHeight - pEdgeHeight, pWidth - pEdgeWidth - pCornerWidth, pEdgeHeight, pTextureX + pCornerWidth, pTextureY + pVHeight - pEdgeHeight, pUWidth - pEdgeWidth - pCornerWidth, pEdgeHeight);
         this.blit(pAtlasLocation, pX + pWidth - pEdgeWidth, pY + pHeight - pEdgeHeight, pTextureX + pUWidth - pEdgeWidth, pTextureY + pVHeight - pEdgeHeight, pEdgeWidth, pEdgeHeight);
         this.blitRepeating(pAtlasLocation, pX, pY + pCornerHeight, pCornerWidth, pHeight - pEdgeHeight - pCornerHeight, pTextureX, pTextureY + pCornerHeight, pCornerWidth, pVHeight - pEdgeHeight - pCornerHeight);
         this.blitRepeating(pAtlasLocation, pX + pCornerWidth, pY + pCornerHeight, pWidth - pEdgeWidth - pCornerWidth, pHeight - pEdgeHeight - pCornerHeight, pTextureX + pCornerWidth, pTextureY + pCornerHeight, pUWidth - pEdgeWidth - pCornerWidth, pVHeight - pEdgeHeight - pCornerHeight);
         this.blitRepeating(pAtlasLocation, pX + pWidth - pEdgeWidth, pY + pCornerHeight, pCornerWidth, pHeight - pEdgeHeight - pCornerHeight, pTextureX + pUWidth - pEdgeWidth, pTextureY + pCornerHeight, pEdgeWidth, pVHeight - pEdgeHeight - pCornerHeight);
      }
   }
